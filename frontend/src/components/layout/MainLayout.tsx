...
import { Coffee, ShoppingBag, User, BarChart3, Package, LogOut, Lock, Wallet } from 'lucide-react';
...
const MainLayout: React.FC<MainLayoutProps> = ({ children }) => {
  ...
  const adminNavItems = state.activeView === 'admin' ? [
    ...
    },
    {
      label: '2FA',
      icon: <Lock size={20} />,
      isActive: state.adminTab === '2fa',
      onClick: () => dispatch({ type: 'SET_ADMIN_TAB', payload: '2fa' })
    },
  ] : [];
